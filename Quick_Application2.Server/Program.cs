...
using Quick_Application2.Core.Services;
using Quick_Application2.Core.Services.Account;
using Quick_Application2.Core.Services.Shop;
using Quick_Application2.Server.Authorization;
using Quick_Application2.Server.Authorization.Requirements;
using Quick_Application2.Server.Configuration;
using Quick_Application2.Server.Services;
using Quick_Application2.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - Quick_Application2";
